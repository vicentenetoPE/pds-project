              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="center">{row.priority ?? 'N/A'}</TableCell>
                    <TableCell align="center">{row.estimatedTime ?? 'N/A'}</TableCell>
                    <TableCell align="center">{row.loggedTime ?? 'N/A'}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
